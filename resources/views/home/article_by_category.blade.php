                ...
                <div class="row">
                    <div class="col-12">
                        <div class="d-flex align-items-center justify-content-between bg-light py-2 px-4 mb-3">
                            ...
                            <h3 class="m-0">{{ $nama_kategori }}</h3>
                            <a class="text-secondary font-weight-medium text-decoration-none" href="">Lihat Semua</a>
                        </div>
                    </div>
                    @foreach ($beberapa_artikel_sesuai_kategori as $artikel_sesuai_kategori )
                        <div class="col-lg-6">
                            <div class="position-relative mb-3">
                                <img class="img-fluid w-100" src="/storage/image/{{ $artikel_sesuai_kategori->image }}" style="object-fit: cover;">
                                <div class="overlay position-relative bg-light">
                                    <div class="mb-2" style="font-size: 14px;">
                                        <a href="">{{ $nama_kategori }}</a>
                                        <span class="px-1">/</span>
                                        <span>{{ $artikel_sesuai_kategori->published_at }}</span>
                                    </div>
                                    <a class="h4" href="">{{ $artikel_sesuai_kategori->title }}</a>
                                    <p class="m-0">{{ \Illuminate\Support\Str::limit($artikel_sesuai_kategori->content, 108) }}</p>
                                </div>
                            </div>
                        </div>
                    @endforeach
