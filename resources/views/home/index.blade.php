                            ...
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    ...
                                    <div class="overlay position-relative bg-light">
                                        ...
                                        <a class="h4" href="/read/{{ $artikel_populer->title }}">{{ $artikel_populer->title }}</a>
                                        <p class="m-0">
                            ...
                            <div class="col-lg-6">
                                <div class="position-relative mb-3">
                                    ...
                                    <div class="overlay position-relative bg-light">
                                        ...
                                        <a class="h4" href="">{{ $artikel_terbaru->title }}</a>
                                ...
                                <div class="d-flex mb-3">
                                    <img src="/storage/image/{{ $artikel_terbaru->image }}"
                                        style="width: 100px; height: 100px; object-fit: cover;">
                                    <div class="w-100 d-flex flex-column justify-content-center bg-light px-3"
                                        style="height: 100px;">
                                        <div class="mb-1" style="font-size: 13px;">
                                            <a href="">{{ $artikel_terbaru->kategori->name }}</a>
                                            <span class="px-1">/</span>
                                            <span>{{ $artikel_terbaru->published_at }}</span>
                                        </div>
                                        <a class="h6 m-0" href="">{{ $artikel_terbaru->title }}</a>
                                    </div>
                                </div>
                            </div>
                        @endforeach
